...
export const getMensajes = createAsyncThunk<void, RequestConfig<NuevaTransferenciaForm>, { state: RootState }>(
  FEATURE_NAME + '/getMensajes',
  async (options, thunkApi) => {
    const { dispatch, getState } = thunkApi;
    const data = options?.data;

    if (!data) throw new Error('GetMensajes - no incluye datos');
